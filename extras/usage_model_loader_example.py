...
# But since we installed it in the previous steps via headers, standard import should work.
# Just in case, we add the current directory to path.
sys.path.append(os.getcwd())

from ai_common.model_loader import ModelLoader, BaseProvider, ApiKeyManager
...
class DummyProvider(BaseProvider):
    ...
    def load_embedding(self, api_key_mgr: ApiKeyManager, config: Dict[str, Any], **kwargs):
